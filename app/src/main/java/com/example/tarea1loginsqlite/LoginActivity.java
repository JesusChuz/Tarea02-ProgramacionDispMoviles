package com.example.tarea1loginsqlite;
...
import com.example.tarea1loginsqlite.R;
        ...
        btnlogin.setOnClickListener(new View.OnClickListener() {
            ...
            if(user.equals("")||pass.equals(""))
                ...
                if(checkuserpass==true){
                    Toast.makeText(LoginActivity.this, "Verificacion exitosa", Toast.LENGTH_SHORT).show();
